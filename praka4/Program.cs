...
zametka1.Description = "Cходить и поспать на парах";
zametka1.Description = "...";
...
zametka4.Description = "Купить хлеб и корнишоны";
...
void zametka(ConsoleKeyInfo key)
{
    if (zametka1.Dade == now.AddDays(plusDay).ToLongDateString())
    {
        ...
        if (key.Key == ConsoleKey.Enter && posicion == 1)
        {
            Console.Clear();
            Console.SetCursorPosition(2, 1);
            Console.WriteLine("1:Дата" + zametki[0].Dade);
            Console.SetCursorPosition(2, 2);
        ...
        else if (key.Key == ConsoleKey.Enter && posicion == 2)
        {
            Console.Clear();
            Console.SetCursorPosition(2, 1);
            Console.WriteLine("1:Дата " + zametki[1].Dade);
            Console.SetCursorPosition(2, 2);
    ...
    else if (zametka3.Dade == now.AddDays(plusDay).ToLongDateString())
    {
        ...
        if (key.Key == ConsoleKey.Enter && posicion == 1)
        {
            Console.Clear();
            Console.SetCursorPosition(2, 1);
            Console.WriteLine("1:Дата " + zametki[2].Dade);
            Console.SetCursorPosition(2, 2);
        ...
        else if (key.Key == ConsoleKey.Enter && posicion == 2)
        {
            Console.Clear();
            Console.SetCursorPosition(2, 1);
            Console.WriteLine("1:Дата " + zametki[3].Dade);
            Console.SetCursorPosition(2, 2);
    ...
    else if (zametka5.Dade == now.AddDays(plusDay).ToLongDateString())
    {
        ...
        if (key.Key == ConsoleKey.Enter && posicion == 1)
        {
            Console.Clear();
            Console.SetCursorPosition(2, 1);
            Console.WriteLine("1:Дата " + zametki[4].Dade);
            Console.SetCursorPosition(2, 2);
